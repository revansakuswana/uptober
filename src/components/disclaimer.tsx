      ...
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <div className="text-center text-[9.3px] md:text-sm mt-4 space-y-4">
          <p>
            ...
            wilder and a lot more fun.
          </p>
          <p>
            {" "}
            There’s no roadmap to riches, only community vibes, and a mission to
            Moowwwn together. If you buy, do it because you believe in the
            energy - not because your cousin said it’ll 100x.
          </p>
          <p>Stay bullish, stay responsible, and keep it UP. Always.</p>
        </div>
      </div>
    </div>
  );
