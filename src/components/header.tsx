...
export default function Header() {
  return (
    <header className="w-full border-y-3 bg-white">
      <div className="mx-auto flex flex-col md:flex-row md:justify-between items-center gap-10 md:gap-10 px-14 py-14 md:px-8 md:py-6 max-w-[67rem]">
        <img src={logo} className="w-full md:w-35 border-2 rounded-lg" />
        <div className="flex flex-wrap justify-center md:justify-end items-center gap-8 md:gap-8 w-full">
